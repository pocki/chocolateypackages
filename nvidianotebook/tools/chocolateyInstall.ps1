...
if($osVersion -ge [version]"10.0.10240.0") {
	$url = "https://us.download.nvidia.com/Windows/$version/$version-notebook-win10-32bit-international-whql.exe"
	$url64 = "https://us.download.nvidia.com/Windows/$version/$version-notebook-win10-64bit-international-whql.exe"
} else {
	$url = "https://us.download.nvidia.com/Windows/$version/$version-notebook-win8-win7-winvista-32bit-international-whql.exe"
	$url64 = "https://us.download.nvidia.com/Windows/$version/$version-notebook-win8-win7-winvista-64bit-international-whql.exe"
}
